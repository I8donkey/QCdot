...
const QHash<QString, QHash<QString, QString>>& Translator::data() {
    static const QHash<QString, QHash<QString, QString>> s_data = {
        {QStringLiteral("en"), {
            ...
            {QStringLiteral("toolbar.undo"),      QStringLiteral("Undo")},
            {QStringLiteral("toolbar.redo"),      QStringLiteral("Redo")},
            {QStringLiteral("toolbar.select_all"), QStringLiteral("Select All")},
            ...
            // Qt Widget Method nodes
            {QStringLiteral("node.WidgetResize"),           QStringLiteral("Resize")},
            {QStringLiteral("node.WidgetMove"),             QStringLiteral("Move")},
            {QStringLiteral("node.WidgetShow"),             QStringLiteral("Show")},
            {QStringLiteral("node.WidgetHide"),             QStringLiteral("Hide")},
            {QStringLiteral("node.WidgetSetEnabled"),       QStringLiteral("Set Enabled")},
            {QStringLiteral("node.WidgetSetVisible"),       QStringLiteral("Set Visible")},
            {QStringLiteral("node.WidgetSetStyleSheet"),    QStringLiteral("Set Style")},
            {QStringLiteral("node.WidgetSetToolTip"),       QStringLiteral("Set Tooltip")},
            {QStringLiteral("node.WidgetSetFixedSize"),     QStringLiteral("Set Fixed Size")},
            {QStringLiteral("node.WidgetSetMinimumSize"),   QStringLiteral("Set Min Size")},
            {QStringLiteral("node.WidgetSetMaximumSize"),   QStringLiteral("Set Max Size")},
            {QStringLiteral("node.WindowSetTitle"),         QStringLiteral("Set Title")},
            {QStringLiteral("node.WindowSetGeometry"),      QStringLiteral("Set Geometry")},
            {QStringLiteral("node.LabelSetText"),           QStringLiteral("Set Text")},
            {QStringLiteral("node.ButtonSetText"),          QStringLiteral("Set Text")},
            {QStringLiteral("node.LineEditSetText"),        QStringLiteral("Set Text")},
            {QStringLiteral("node.LineEditGetText"),        QStringLiteral("Get Text")},
            {QStringLiteral("node.SliderSetValue"),         QStringLiteral("Set Value")},
            {QStringLiteral("node.SliderGetValue"),         QStringLiteral("Get Value")},
            {QStringLiteral("node.ProgressBarSetValue"),    QStringLiteral("Set Value")},
            {QStringLiteral("node.CheckBoxSetChecked"),     QStringLiteral("Set Checked")},
            {QStringLiteral("node.CheckBoxIsChecked"),      QStringLiteral("Is Checked")},
            {QStringLiteral("node.SpinBoxSetValue"),        QStringLiteral("Set Value")},
            {QStringLiteral("node.SpinBoxGetValue"),        QStringLiteral("Get Value")},
            {QStringLiteral("node.ComboBoxAddItem"),        QStringLiteral("Add Item")},
            {QStringLiteral("node.ComboBoxGetCurrentText"), QStringLiteral("Get Text")},
            {QStringLiteral("node.WidgetClose"),            QStringLiteral("Close")},
            {QStringLiteral("node.WidgetDelete"),           QStringLiteral("Delete")},
            // Categories
            {QStringLiteral("category.all"),           QStringLiteral("All Nodes")},
            {QStringLiteral("category.input"),         QStringLiteral("Input")},
            {QStringLiteral("category.output"),        QStringLiteral("Output")},
            {QStringLiteral("category.container"),     QStringLiteral("Container")},
            {QStringLiteral("category.widget"),        QStringLiteral("Widget")},
            {QStringLiteral("category.widget_method"), QStringLiteral("Widget Method")},
            {QStringLiteral("category.math"),          QStringLiteral("Math")},
            {QStringLiteral("category.logic"),         QStringLiteral("Logic")},
            {QStringLiteral("category.string"),        QStringLiteral("String")},
            {QStringLiteral("category.data"),          QStringLiteral("Data")},
            {QStringLiteral("category.convert"),       QStringLiteral("Convert")},
            {QStringLiteral("category.file"),          QStringLiteral("File")},
            {QStringLiteral("category.util"),          QStringLiteral("Util")},
        ...
        {QStringLiteral("zh"), {
            ...
            {QStringLiteral("toolbar.undo"),      QStringLiteral("撤销")},
            {QStringLiteral("toolbar.redo"),      QStringLiteral("重做")},
            {QStringLiteral("toolbar.select_all"), QStringLiteral("全选")},
            ...
            // Qt Widget Method nodes
            {QStringLiteral("node.WidgetResize"),           QStringLiteral("调整大小")},
            {QStringLiteral("node.WidgetMove"),             QStringLiteral("移动位置")},
            {QStringLiteral("node.WidgetShow"),             QStringLiteral("显示")},
            {QStringLiteral("node.WidgetHide"),             QStringLiteral("隐藏")},
            {QStringLiteral("node.WidgetSetEnabled"),       QStringLiteral("设置启用")},
            {QStringLiteral("node.WidgetSetVisible"),       QStringLiteral("设置可见")},
            {QStringLiteral("node.WidgetSetStyleSheet"),    QStringLiteral("设置样式")},
            {QStringLiteral("node.WidgetSetToolTip"),       QStringLiteral("设置提示")},
            {QStringLiteral("node.WidgetSetFixedSize"),     QStringLiteral("设置固定大小")},
            {QStringLiteral("node.WidgetSetMinimumSize"),   QStringLiteral("设置最小大小")},
            {QStringLiteral("node.WidgetSetMaximumSize"),   QStringLiteral("设置最大大小")},
            {QStringLiteral("node.WindowSetTitle"),         QStringLiteral("设置标题")},
            {QStringLiteral("node.WindowSetGeometry"),      QStringLiteral("设置几何属性")},
            {QStringLiteral("node.LabelSetText"),           QStringLiteral("设置文本")},
            {QStringLiteral("node.ButtonSetText"),          QStringLiteral("设置文本")},
            {QStringLiteral("node.LineEditSetText"),        QStringLiteral("设置文本")},
            {QStringLiteral("node.LineEditGetText"),        QStringLiteral("获取文本")},
            {QStringLiteral("node.SliderSetValue"),         QStringLiteral("设置值")},
            {QStringLiteral("node.SliderGetValue"),         QStringLiteral("获取值")},
            {QStringLiteral("node.ProgressBarSetValue"),    QStringLiteral("设置值")},
            {QStringLiteral("node.CheckBoxSetChecked"),     QStringLiteral("设置选中")},
            {QStringLiteral("node.CheckBoxIsChecked"),      QStringLiteral("是否选中")},
            {QStringLiteral("node.SpinBoxSetValue"),        QStringLiteral("设置值")},
            {QStringLiteral("node.SpinBoxGetValue"),        QStringLiteral("获取值")},
            {QStringLiteral("node.ComboBoxAddItem"),        QStringLiteral("添加选项")},
            {QStringLiteral("node.ComboBoxGetCurrentText"), QStringLiteral("获取当前文本")},
            {QStringLiteral("node.WidgetClose"),            QStringLiteral("关闭")},
            {QStringLiteral("node.WidgetDelete"),           QStringLiteral("删除")},
            // Categories
            {QStringLiteral("category.all"),           QStringLiteral("全部节点")},
            {QStringLiteral("category.input"),         QStringLiteral("输入")},
            {QStringLiteral("category.output"),        QStringLiteral("输出")},
            {QStringLiteral("category.container"),     QStringLiteral("容器")},
            {QStringLiteral("category.widget"),        QStringLiteral("控件")},
            {QStringLiteral("category.widget_method"), QStringLiteral("控件方法")},
            {QStringLiteral("category.math"),          QStringLiteral("数学")},
            {QStringLiteral("category.logic"),         QStringLiteral("逻辑")},
            {QStringLiteral("category.string"),        QStringLiteral("字符串")},
            {QStringLiteral("category.data"),          QStringLiteral("数据")},
            {QStringLiteral("category.convert"),       QStringLiteral("转换")},
            {QStringLiteral("category.file"),          QStringLiteral("文件")},
            {QStringLiteral("category.util"),          QStringLiteral("工具")},
            // Additional node types used by picker
